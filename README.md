...
6. From the folder where files are uploaded execute:
   ```sh
   python3 predict_trt --input_node resnet50_input --output_node dense_1/Softmax --path w_tf_32_tensorrt.pb --img_path img0.jpg --labels weather_labels.json --shape_size 224 --time true
   ```
