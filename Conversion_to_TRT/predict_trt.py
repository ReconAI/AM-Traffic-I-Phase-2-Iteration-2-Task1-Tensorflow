# python3 predict_trt --input_node resnet50_input --output_node dense_1/Softmax --path ./model/trt_graph.pb --img_path ./data/img0.jpg
# python3 predict_trt --input_node test_input --output_node  test_output/BiasAdd --path ./model/trt_graph.pb --img_path ./data/img0.jpg
